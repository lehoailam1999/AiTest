...
export const UNIT_RANK_POLICY = {
  ...
  weakClientAppAdminRe:
    /(\/clientapp\/|\/client-app\/|\/wwwroot\/|angular|\/components?\/|\/pages?\/|\/views?\/).+/i,
  /** Thin HTTP / chunk upload clients — not business-rule SUT. */
  weakHttpClientRe:
    /(resumable-?upload|chunked-?upload|multipart-upload|form-?data-?upload)/i,
  preferPathShapes: [
    "handler",
    "command",
    "query",
 ...
 */
export const UNIT_PROMPT_RULES_CORE: readonly string[] = [
