 ...
 */
export type CodegenAction = "APPLY_FILES" | "RUN_TESTS" | "GENERATE_UNIT_BATCH" | "GENERATE_E2E_BATCH" | "CANCEL";
export type CodegenFileKind = "spec" | "page" | "fixture" | "config" | "unit" | "helper" | "other";
...
export type CodegenProjectRulesSource = "e2e-conventions" | "unit-conventions" | "none" | "body";
...
export type CodegenTestRunner = "playwright" | "dotnet" | "jest" | "vitest" | "pytest" | "custom";
...
export type CodegenFileStatus = "CREATED" | "UPDATED" | "SKIPPED" | "REJECTED_JAIL" | "ERROR";
...
export type CodegenResultStatus = "COMPLETED" | "PARTIAL" | "FAILED" | "CANCELLED" | "RUNNING";
...
export type CodegenProgressPhase = "queued" | "applying" | "generating" | "guarding" | "running" | "done";
