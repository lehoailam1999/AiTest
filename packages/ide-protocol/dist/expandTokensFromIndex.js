...
const HANDLER_SUFFIX = /(CommandHandler|QueryHandler|Handler|Service|Controller|Manager|UseCase|Repository|Command|Query)$/i;
function uniq(xs) {
    const seen = new Set();
    const out = [];
    for (const x of xs) {
 ...
 */
export function expandTokensFromIndex(raw, paths, opts) {
